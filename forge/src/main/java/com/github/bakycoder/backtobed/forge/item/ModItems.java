...
public class ModItems {
     ...
     */
    private static final HashMap<RegistryObject<Item>, CreativeModeTab> ITEM_TAB_MAP = new HashMap<>();
     ...
     */
    private static void registerItemAndAcceptToTab(String itemName, Supplier<Item> item, CreativeModeTab tab) {
     ...
     *
     * @param event The CreativeModeTabEvent.BuildContents event.
     */
    public static void acceptItemsToTabs(CreativeModeTabEvent.BuildContents event) {
